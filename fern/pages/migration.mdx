...
The renamed package is not published yet; use the quickstart's source/tarball
installation. Change imports to `loopiter`, `loopiter/postgres` and `loopiter/testing`,
