...
| Starter | OpenAI Responses via fetch, PostgreSQL prompt registry, exact-match evaluation, CLI | User credentials/model; synthetic example dataset must be replaced for customer claims |
